...
const Showcase = () => {
  const isTabblet = useMediaQuery({ query: "(max-width: 1024px)" });
  ...
  useGSAP(() => {
    if (!isTabblet) {
      ...
      timeline
        ...
        .to(".content", { opacity: 1, y: 0, ease: "power.in" });
    }
  }, [isTabblet]);
  ...
  return (
    <section id="showcase">
      <div className="media">
        <video src="/videos/game.mp4" loop muted autoPlay Inline />
          ...
          <div className="lg:max-w-md">
            ...
            <div className="space-y-5 mt-7 pe-10">
              ...
              <p>
                ...
                unbelivably thin, light, and powerful.
              </p>
